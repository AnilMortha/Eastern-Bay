...
const SolarCalculator = () => {
  ...
  const calculateSolarRequirements = () => {
    ...
    const systemSizeKw = (dailyUnits / locationData.solarHours) * usageData.factor;
    ...
    const recommendedSize = standardSizes.find(size => size >= finalSystemSize) || 
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              width: '100%',
              padding: '15px',
              background: !formData.electricityBill ? '#cbd5e1' : 'linear-gradient(135deg, #0d9488 0%, #0f766e 100%)',
              color: 'white',
              border: 'none',
              borderRadius: '8px',
              fontSize: '18px',
          ...
          {showResults && results ? (
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '36px', fontWeight: '700', color: '#0f766e' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', color: '#059669' }}>
                  ...
                  <span style={{ fontWeight: '600' }}>-₹{results.govtSubsidy.toLocaleString()}</span>
                </div>
                <div style={{ 
                  display: 'flex', 
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                  <div style={{ 
                    ...
                    <div style={{ fontSize: '12px', color: '#166534' }}>CO₂ Reduction</div>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ fontSize: '12px', color: '#166534' }}>Equivalent Trees</div>
                    <div style={{ fontSize: '16px', fontWeight: '600', color: '#166534' }}>
              ...
              <div style={{ 
                ...
                <div style={{ fontSize: '13px', color: '#92400e' }}>
                  ...
                  • Battery Backup: {results.batteryBackup}<br/>
              ...
              onMouseEnter={(e) => {
                e.target.style.transform = 'translateY(-2px)';
                e.target.style.boxShadow = '0 5px 15px rgba(245, 158, 11, 0.4)';
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = 'none';
